...
public class DatabasechangeloglockRecord extends UpdatableRecordImpl<DatabasechangeloglockRecord> implements VertxPojo, Record4<Integer, Boolean, Timestamp, String>, IDatabasechangeloglock {

    private static final long serialVersionUID = -998117664;
